...
public class MainActivity extends AppCompatActivity {
    private TextView numbers, colors, members, phrases;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        colors.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(view.getContext(),"Colors clicked!",Toast.LENGTH_SHORT).show();
        ...
        members = (TextView) findViewById(R.id.family);
        members.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               Intent family=new Intent(MainActivity.this,MembersActivity.class);
